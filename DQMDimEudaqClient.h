/*
 *
 * DQMDimEudaqClient.h header template automatically generated by a class generator
...
public:
	/** Constructor
	 */
	DimEventRequestRpc(DQMDimEudaqClient *pCollector);
...
private:
	// the collector
	DQMDimEudaqClient        *m_pCollector;
};

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------

/** DQMDimEudaqClient class
 */
class DQMDimEudaqClient : public DQMEventCollectorImp, public DimServer
{
